...
# 🚀 Starting Scriblli...
printf "🚀 Starting Scriblli...\n\n"

# 🔐 Check certificate configuration
printf "🔐 Checking certificate configuration...\n"

CERT_PATH="${NEXT_PRIVATE_SIGNING_LOCAL_FILE_PATH:-/opt/Scriblli/cert.p12}"

if [ -f "$CERT_PATH" ] && [ -r "$CERT_PATH" ]; then
    printf "✅ Certificate file found and readable - document signing is ready!\n"
else
    printf "⚠️  Certificate not found or not readable\n"
    printf "💡 Tip: Scriblli will still start, but document signing will be unavailable\n"
    printf "🔧 Check: http://localhost:3000/api/certificate-status for detailed status\n"
fi

printf "\n📚 Useful Links:\n"
printf "📖 Documentation: https://docs.Scriblli.com\n"
printf "🐳 Self-hosting guide: https://docs.Scriblli.com/developers/self-hosting\n"
printf "🔐 Certificate setup: https://docs.Scriblli.com/developers/self-hosting/signing-certificate\n"
