# Scriblli Code Style Guide

This document captures the code style, patterns, and conventions used in the Scriblli codebase. It covers both enforceable rules and subjective "taste" elements that make our code consistent and maintainable.
...
// 3. Internal package imports (from @Scriblli/*)
