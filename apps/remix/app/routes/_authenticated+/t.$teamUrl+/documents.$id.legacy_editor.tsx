...
import { logDocumentAccess } from '@Scriblli/lib/utils/logger';
import { canAccessTeamDocument, formatDocumentsPath } from '@Scriblli/lib/utils/teams';
...
export default function DocumentEditPage() {
  ...
  return (
    <div className="mx-auto -mt-4 w-full max-w-screen-xl px-4 md:px-8">
      <Link to={documentRootPath} className="flex items-center text-scriblli-700 hover:opacity-80">
