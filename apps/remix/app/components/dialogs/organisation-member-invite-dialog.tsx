...
export const OrganisationMemberInviteDialog = ({
  ...
  const downloadTemplate = () => {
    const data = [
      { email: 'admin@scribl.li', role: 'Admin' },
      { email: 'manager@scribl.li', role: 'Manager' },
      { email: 'member@scribl.li', role: 'Member' },
    ];
    ...
    downloadFile({
      filename: 'scriblli-organisation-member-invites-template.csv',
      data: blob,
    });
  };
