---
title: Home
description: Scriblli aims to be the world's most trusted document-signing tool. Join us in creating the next generation of open trust infrastructure.
---
...
import cardBeautifulFigure from '@Scriblli/assets/images/card-beautiful-figure.png';
import cardConnectionsFigure from '@Scriblli/assets/images/card-connections-figure.png';
import cardPaidFigure from '@Scriblli/assets/images/card-paid-figure.png';
import cardSharingFigure from '@Scriblli/assets/images/card-sharing-figure.png';
...
<Wrapper>
  ...
  <div className="flex flex-col items-center mb-16">
    ...
    <span className="text-muted-foreground mx-auto mt-4 max-w-2xl text-center leading-normal tracking-tight">Scriblli aims to be the world's most trusted document-signing tool. Join us in creating the next generation of open trust infrastructure.</span>
