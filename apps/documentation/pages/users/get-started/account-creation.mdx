...
description: Learn how to create an account on Scriblli.
---
...
The first step to start using Scriblli is to pick a plan and create an account. At the moment of writing this guide, we have 4 plans available:
...
Explore each plan's features and choose the one that best suits your needs. The [pricing page](https://scribl.li/pricing) has more information about the plans.
...
To create a free account, navigate to the [registration page](https://scribl.li/free) and fill in the required information.
