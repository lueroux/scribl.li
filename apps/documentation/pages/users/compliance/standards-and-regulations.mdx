...
description: Learn about the different standards and regulations for Scriblli.
---
...
> Read more about 21 CFR Part 11 with Scriblli here: https://scribl.li/21-CFR-Part-11
...
<Callout type="info" emoji="✅">
  Status: [Compliant](https://scribl.li/trust)
</Callout>
...
<Callout type="warning" emoji="⏳">
  Status: [Planned](https://github.com/Scriblli/backlog/issues/26)
</Callout>
...
<Callout type="warning" emoji="⏳">
  Status: [Planned](https://github.com/Scriblli/backlog/issues/25)
</Callout>
