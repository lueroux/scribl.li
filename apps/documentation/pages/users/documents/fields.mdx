...
description: Learn about the different fields you can add to your documents in Scriblli.
---

# Document Fields

Learn about the different fields you can add to your documents in Scriblli and how to make the most of them.

## Signature Field

The signature field collects the signer's signature. It's required for each recipient with the "Signer" role.

![The signature field in the Scriblli document editor](/document-signing/signature-field-document-editor-view.webp)
...
![The email field in the Scriblli document editor](/document-signing/email-field-document-editor-view.webp)
...
![The name field in the Scriblli document editor](/document-signing/name-field-document-editor-view.webp)
...
![The initials field in the Scriblli document editor](/document-signing/initials-field-document-editor-view.webp)
...
![The date field in the Scriblli document editor](/document-signing/date-field-document-editor-view.webp)
...
![The text field in the Scriblli document editor](/document-signing/text-field-document-editor-view.webp)
...
![The number field in the Scriblli document editor](/document-signing/number-field-document-editor-view.webp)
...
![The radio field in the Scriblli document editor](/document-signing/radio-field-document-editor-view.webp)
...
![The checkbox field in the Scriblli document editor](/document-signing/checkbox-field-document-editor-view.webp)
...
![The dropdown/select field in the Scriblli document editor](/document-signing/dropdown-field-document-editor-view.webp)
