---
title: Templates
description: Learn how to create and use templates in Scriblli.
---
...
Scriblli allows you to create templates, which are reusable documents. Templates are helpful if you often send the same type of document, such as contracts, agreements, or invoices, as they help you save time.
...
![Scriblli template page](/templates/Scriblli-template-page.webp)
...
![A successfully uploaded document in the Scriblli dashboard](/templates/Scriblli-template-page-uploaded-document.webp)
...
- placeholder@Scriblli.com
- me@Scriblli.com

![Adding placeholder recipients for the Scriblli template](/templates/Scriblli-template-recipients.webp)
...
![Use an available Scriblli template](/templates/Scriblli-use-template.webp)
