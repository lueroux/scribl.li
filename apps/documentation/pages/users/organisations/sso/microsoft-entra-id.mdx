...
Microsoft Entra ID (formerly Azure Active Directory) is a popular identity provider for enterprise SSO. This guide will walk you through creating an app registration and configuring it for use with your Scriblli SSO portal.

## Prerequisites

- Access to Microsoft Entra ID (Azure AD) admin center
- Access to your Scriblli organisation as an administrator or manager
...
- **Name**: Your preferred name (e.g. `Scriblli SSO Portal`)
- **Supported account types**: Choose based on your needs
- **Redirect URI (Web)**: Found in the Scriblli SSO portal settings page

Click "Register" to create the app registration.

### Get Client ID

After registration, you'll be taken to the app's overview page. The **Application (client) ID** is displayed prominently - this is your Client ID for Scriblli.

### Create Client Secret

1. In the left sidebar, click on "Certificates & secrets"
2. Click "New client secret"
3. Add a description (e.g., "Scriblli SSO Secret")
...
## Configure Scriblli SSO Portal

Now you have all the information needed to configure your Scriblli SSO portal:
