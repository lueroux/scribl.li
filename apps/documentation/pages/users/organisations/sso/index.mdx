...
- **Single Sign-On**: Access Scriblli using your own authentication system
...
Create a custom subdomain for your organisation's SSO portal. For example, you can create a subdomain like `Scriblli.your-organisation.com` which redirects to the portal link.
...
- Ensure the redirect URI in Scriblli matches exactly what's configured in your identity provider
...
2. Check the Scriblli logs for detailed error messages
