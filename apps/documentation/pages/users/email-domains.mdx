---
title: Email Domains
description: Learn how to create and manage email domains in Scriblli.
---
...
Email Domains allow you to send emails to recipients from your own domain instead of the default Scriblli email address.
...
- Access to your Scriblli organisation as an admin or manager
...
After adding your domain, Scriblli will provide you with the following required DNS records that need to be configured on your domain:
...
Once you've added the DNS records, return to the Scriblli email domains settings page and click the "Verify" button.
