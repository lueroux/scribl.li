...
description: Learn how to set up your public profile on Scriblli.
---
...
Scriblli allows you to create a public profile to share your templates for anyone to sign. This is useful for distributing and collecting signatures for commonly used documents, making it more efficient for both the document creator and the signers.

<Callout type="info">A free Scriblli account gives you 5 free signatures per month.</Callout>
...
![The profile settings page](/public-profile/Scriblli-public-profile-settings.webp)
...
```bash
https://app.Scriblli.com/p/<username>
```
...
![An example of a enabling a public profile on Scriblli](/public-profile/Scriblli-enable-public-profile-settings.webp)
...
![An example of a public profile on Scriblli](/direct-links/Scriblli-profile.webp)

The image above shows an example of a public profile on Scriblli.
...
<Callout>Tag @Scriblli on X to get a retweet and an endorsement from us.</Callout>
