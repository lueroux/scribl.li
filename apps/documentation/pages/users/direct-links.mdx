...
![Template page in the Scriblli dashboard](/direct-links/document-direct-link-Scriblli.webp)
...
![Enable the document direct link in the Scriblli dashboard](/direct-links/enable-document-direct-link-modal.webp)
...
![Choose the Direct Link recipient](/direct-links/choose-direct-link-recipient-Scriblli.webp)
...
```bash
https://app.Scriblli.com/d/<random-generated-string>
```

### Optional: Add Templates to Your Profile

You can add templates with direct links to your public [Scriblli profile](/users/profile) to make them signable anytime.

![Choose the Direct Link recipient](/direct-links/Scriblli-profile.webp)
