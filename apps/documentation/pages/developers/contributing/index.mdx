...
description: Learn how to contribute to Scriblli and become part of our community.
---
...
This guide will help you get started with contributing to Scriblli.
...
Search the existing [issues](https://github.com/Scriblli/Scriblli/issues) to see if someone else reported the same issue. Or, check the [existing PRs](https://github.com/Scriblli/Scriblli/pulls) to see if someone else is already working on the same thing.
...
<Callout type="info">
  If you need help getting started, [join us on Discord](https://scribl.li/discord).
</Callout>
