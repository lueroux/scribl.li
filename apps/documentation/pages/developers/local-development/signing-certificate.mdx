...
Details about environment variables associated with certificates can be found [here](/developers/self-hosting/signing-certificate#configure-Scriblli-to-use-the-certificate).
