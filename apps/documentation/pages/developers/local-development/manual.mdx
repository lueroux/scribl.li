---
title: Manual Setup
description: Manually set up Scriblli on your machine for local development.
---
...
Follow these steps to set up Scriblli on your local machine:

<Steps>

### Fork Scriblli

Fork the [Scriblli repository](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/working-with-forks/about-forks) to your GitHub account.
...
```bash
npm run prisma:seed -w @Scriblli/prisma
```
