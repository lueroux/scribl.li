...
In addition to embedding signing experiences, Scriblli now supports embedded authoring, allowing you to integrate document and template creation and editing directly within your application.
...
```jsx
import { EmbedCreateDocumentV1 } from '@Scriblli/embed-react';
...
```jsx
import { EmbedCreateTemplateV1 } from '@Scriblli/embed-react';
...
```jsx
import { EmbedUpdateDocumentV1 } from '@Scriblli/embed-react';
...
```jsx
import { EmbedUpdateTemplateV1 } from '@Scriblli/embed-react';
...
This API endpoint requires authentication with your Scriblli API key. The token has a default expiration of 1 hour, but you can customize this duration based on your security requirements.

You can find more details on this request at our [API Documentation](https://openapi.Scriblli.com/reference#tag/embedding)
...
| `host`             | string  | Optional custom host URL. Defaults to `https://app.Scriblli.com`.         |
...
import { EmbedCreateDocumentV1, EmbedUpdateDocumentV1 } from '@Scriblli/embed-react';
