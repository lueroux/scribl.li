...
https://app.Scriblli.com/t/<team-url>/documents/<envelope-id>/legacy_editor?devmode=true
```
...
https://app.Scriblli.com/t/<team-url>/documents/<envelope-id>/edit?step=addFields&devmode=true
```
