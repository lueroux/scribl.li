...
description: Learn how to run Scriblli locally, use our API, integrate webhooks, contribute to the project, and self-host Scriblli.
---
...
<Cards>
  ...
  <Cards.Card title="Self-host Scriblli" href="/developers/self-hosting" />
</Cards>
