...
description: Learn how to generate or buy a signing certificate for your Scriblli instance.
---
...
Self-hosting your Scriblli instance requires your own certificate to sign documents. [This article](https://Scriblli.com/blog/building-Scriblli-pt1) explains why.
...
Receiving your signing certificate is similar to receiving an SSL certificate. Since you need the actual certificate as part of the Scriblli config, you must generate a secret private key and a CSR (Certificate Signing Request).
...
### Configure Scriblli to use the certificate
