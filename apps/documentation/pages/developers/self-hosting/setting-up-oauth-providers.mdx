...
description: Learn how to set up OAuth providers for your own instance of Scriblli.
---
...
9. Set the authorized javascript origins to `https://<Scriblli-domain>`
10. Set the authorized redirect URIs to `https://<Scriblli-domain>/api/auth/callback/google`
11. In the Scriblli environment variables, set the following:
...
5. Enter a name for your application (e.g., "Scriblli")
...
7. Under **Redirect URI**, select **Web** and enter: `https://<Scriblli-domain>/api/auth/callback/microsoft`
8. Click **Register**
...
7. In the Scriblli environment variables, set the following:
