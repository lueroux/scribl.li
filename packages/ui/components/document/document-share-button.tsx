...
import { useCopyShareLink } from '@Scriblli/lib/client-only/hooks/use-copy-share-link';
import { NEXT_PUBLIC_WEBAPP_URL } from '@Scriblli/lib/constants/app';
import { generateTwitterIntent } from '@Scriblli/lib/universal/generate-twitter-intent';
  ...
  const onTweetClick = async () => {
    ...
    window.open(
      generateTwitterIntent(
        `I just ${token ? 'signed' : 'sent'} a document in style with @Scriblli. Check it out!`,
      ...
      <DialogContent position="end">
        ...
        <div className="flex w-full flex-col">
          <div className="rounded-md border p-4">
            ...
            <span className="font-medium text-blue-400">@Scriblli</span>
            . Check it out!
