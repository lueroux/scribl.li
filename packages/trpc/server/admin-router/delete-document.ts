import { adminSuperDeleteDocument } from '@Scriblli/lib/server-only/admin/admin-super-delete-document';
import { sendDeleteEmail } from '@Scriblli/lib/server-only/document/send-delete-email';
