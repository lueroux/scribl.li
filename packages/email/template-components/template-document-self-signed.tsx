...
export const TemplateDocumentSelfSigned = ({
  ...
  const signUpUrl = `${NEXT_PUBLIC_WEBAPP_URL ?? 'https://scribl.li'}/signup`;
      ...
      <Section className="flex-row items-center justify-center">
        ...
        <Text className="mx-auto mb-6 mt-1 max-w-[80%] text-center text-base text-slate-400">
          <Trans>
            ...
            <Link
              href={signUpUrl}
              target="_blank"
              className="text-Scriblli-700 hover:text-Scriblli-600 whitespace-nowrap"
            >
              free account
            </Link>{' '}
        ...
        <Section className="mb-6 mt-8 text-center">
          ...
          <Button
            ...
            href="https://Scriblli.com/pricing"
          >
            <Img
