...
import { ApiContractV1 } from '@Scriblli/api/v1/contract';
import { ApiContractV1Implementation } from '@Scriblli/api/v1/implementation';
import { OpenAPIV1 } from '@Scriblli/api/v1/openapi';
import { testCredentialsHandler } from '@Scriblli/lib/server-only/public-api/test-credentials';
import { listDocumentsHandler } from '@Scriblli/lib/server-only/webhooks/zapier/list-documents';
import { subscribeHandler } from '@Scriblli/lib/server-only/webhooks/zapier/subscribe';
import { unsubscribeHandler } from '@Scriblli/lib/server-only/webhooks/zapier/unsubscribe';
...
tsRestHonoApp
  .get('/openapi', (c) => c.redirect('https://openapi-v1.Scriblli.com'))
